...
function Footer() {
    return <>
            <div style={{display:'flex', fontSize: '10px', marginTop: '5px', marginBottom:'20px'}} class="justify-content-around"> 
                <div style={{backgroundColor:'#F5B629', marginRight:'5px',height:'1px', width: '30%', marginTop:'6px'}}></div>
                <div style={{marginRight:'5px', color:'#F5B629'}}>Sign Up using</div>
